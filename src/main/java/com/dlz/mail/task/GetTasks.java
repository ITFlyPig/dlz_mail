        ...
        synchronized(this) {
            while (!isStop) {
                try {
                    ...
                    List<MailTaskBean> tasks = queryRunner.query(Constant.SQL.GET_WAIT_HANDLE_SQL_TASK, new BeanListHandler<MailTaskBean>(MailTaskBean.class), Constant.EmailStatus.NEW);
